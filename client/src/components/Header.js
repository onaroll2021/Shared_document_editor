...
export default function Header() {
  return (
    ...
    <button class="button button-icon px-5" >
    ...
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" color='gray' size='3xl' class="w-6 h-6">
